...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  ...
  'umlauf_rueckmeldung': {
    aufgabentyp: [{ key: "kenntnisnahme", label: "Kenntnisnahme" }, { key: "genehmigung", label: "Genehmigung" }],
    entscheidung: [{ key: "ja", label: "Ja (Zur Kenntnis genommen / Genehmigt)" }, { key: "nein", label: "Nein (Abgelehnt)" }],
  },
  'umlaufmappe_personen': {
    aufgabentyp: [{ key: "zustimmung", label: "Zustimmung/Ablehnung" }, { key: "kenntnisnahme", label: "Kenntnisnahme" }],
  },
};
