...
export function useDashboardData() {
  ...
  const fetchAll = useCallback(async () => {
    setError(null);
    try {
      const [umlaufmappeData, personenstammData, umlaufRueckmeldungData, umlaufmappePersonenData] = await Promise.all([
  ...
  return { umlaufmappe, setUmlaufmappe, personenstamm, setPersonenstamm, umlaufRueckmeldung, setUmlaufRueckmeldung, umlaufmappePersonen, setUmlaufmappePersonen, loading, error, fetchAll, umlaufmappeMap, personenstammMap };
}