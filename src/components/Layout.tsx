...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconUsers } from '@tabler/icons-react';
...
const APP_TITLE = 'Digitale Umlaufmappe';
...
const navigation = [
  ...
  { name: 'Umlaufmappe', href: '/umlaufmappe', icon: IconFileText },
  { name: 'Umlaufmappe_Personen', href: '/umlaufmappe-personen', icon: IconUsers },
  { name: 'Personenstamm', href: '/personenstamm', icon: IconUsers },
  { name: 'Umlauf-Rückmeldung', href: '/umlauf-rueckmeldung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Umlaufmappe', href: '/gateway/apps/69d34a329d0bfb14d67f386b?template=list_page', icon: IconFileText },
  { name: 'Umlaufmappe_Personen', href: '/gateway/apps/69d358ffabb893c23e32b85e?template=list_page', icon: IconUsers },
  { name: 'Personenstamm', href: '/gateway/apps/69d34a2fba1095e8bb80aaad?template=list_page', icon: IconUsers },
  { name: 'Umlauf-Rückmeldung', href: '/gateway/apps/69d34a339891a25a6262faa6?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69d34a329d0bfb14d67f386b?template=list_page"
